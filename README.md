...
- **B2B Portfolio Intelligence** _(Paid Tier)_ — Multi-building dashboard, 12–36 month cost forecasting, budget variance alerts, and exportable reports for schools, hospitals, and property managers.
...
| Role         | Name         | GitHub                                         |
| ------------ | ------------ | ---------------------------------------------- |
| **Frontend** | Manuel Roman | [@OasisView](https://github.com/OasisView)     |
| **Backend**  | Joshua Viera | [@JoshuaViera](https://github.com/JoshuaViera) |
